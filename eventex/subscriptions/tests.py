...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Ricardo Anzolin', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('ricardoanzolin@gmail.com', email.body)
        self.assertIn('4684098444', email.body)
...
class SubscribeSuccessMessage(TestCase):
    def test_message(self):
        data = dict(name='Henrique Bastos', cpf='12345678901', email='ricardoanzolin@gmail.com', phone='4684098444')
